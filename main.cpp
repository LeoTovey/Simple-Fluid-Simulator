...
int main()
{
    ...
    Shader asteroidShader(
            "F:\\Simple-Fluid-Simulator\\resources\\rock.vs",
            "F:\\Simple-Fluid-Simulator\\resources\\rock.fs");

    // load models
    // -----------
    Model rock("F:\\Simple-Fluid-Simulator\\resources\\rock.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (int i = 0; i < amount; ++i)
        {
            ...
            translate = glm::scale(translate,glm::vec3(0.1, 0.1, 0.1));
